...
<h1 class="page-title"><i class="fa fa-balance-scale"></i> Trial Balance</h1>
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-check-circle"></i> Trial Balance Form
        </div>
    </div>
    <div class="portlet-body">
        <form method="GET" action="<?php echo site_url('finance/trialbalance/generate') ?>" target="_blank">
            <div class="row">
