...
<h1 class="page-title"><i class="fa fa-file"></i> Balance Sheet</h1>
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-check-circle"></i> Balance Sheet Form
        </div>
    </div>
    <div class="portlet-body">
        <form method="GET" action="<?php echo site_url('finance/balancesheet/generate') ?>" target="_blank">
            <div class="row">
