...
<div class="form-group">
    <form id="project-form" class="form-horizontal" action="javascript:;">
        ...
        <button type="submit" class="btn grey-mint sbold uppercase btn-sm pull-right" name="submit"><i
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('button[name="select-comp"]').on('click', function () {
            ...
            var newRow = "<tr>" +
                ...
                "<td>" + comp_name + "</td>" +
                "<td align=\"center\"><button onclick=\"deleteRow(this)\" class=\"btn red btn-xs\"><i class=\"fa fa-remove\"></i></button></td>" +
                "</tr>";
    ...
    $('button[name="submit"]').on('click', function () {
        var url = '<?php echo base_url('/setup/company/add_company_consolidate');?>';
