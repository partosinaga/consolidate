            ...
            <?php foreach ($consolidate as $cons): ?>
                <div class="timeline-item">
                    <div class="timeline-badge">
                        <img class="timeline-badge-userpic" src="<?php echo base_url() ?>/assets/layouts/layout/img/GL.png"/></div>
                    <div class="timeline-body">
                        <div class="timeline-body-arrow"></div>
                        <div class="timeline-body-head">
                            <div class="timeline-body-head-caption">
                                <a href="<?php echo ('https://app.monstera.co/'.$cons->database); ?>" target="_blank" class="timeline-body-title font-blue-madison"><?php echo $cons->company_code ?></a>
                            </div>
                        </div>
